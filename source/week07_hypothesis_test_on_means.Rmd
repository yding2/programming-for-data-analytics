...
<div class="match-quiz" id="fitness-app-match">
<p class="match-title"><strong>Match each description with the correct term.</strong></p>
<p><strong>Terms:</strong> Hypotheses; Type I error; Type II error; Type I error consequence; Type II error consequence</p>

<div class="match-item" data-answer="hypotheses">
<p><strong>a)</strong> H<sub>0</sub>: &mu; = 100, &nbsp;&nbsp; H<sub>1</sub>: &mu; &gt; 100</p>
<select aria-label="Answer for item a">
...
<span class="match-feedback" aria-live="polite"></span>
</div>

<div class="match-item" data-answer="type1-consequence">
<p><strong>b)</strong> Spend additional time and money to improve the app’s accuracy when the app already meets the desired accuracy level.</p>
<select aria-label="Answer for item b">
<option value="">Select a term</option>
<option value="hypotheses">Hypotheses</option>
<option value="type1">Type I error</option>
<option value="type2">Type II error</option>
...
<p><strong>c)</strong> Decide based on the hypothesis test that the mean error is 100 calories, but in reality the mean error is greater than 100 calories.</p>
<select aria-label="Answer for item c">
<option value="">Select a term</option>
<option value="hypotheses">Hypotheses</option>
<option value="type1">Type I error</option>
<option value="type2">Type II error</option>
...
<p><strong>d)</strong> Decide based on the hypothesis test that the mean error is greater than 100 calories, but in reality the mean error is 100 calories.</p>
<select aria-label="Answer for item d">
<option value="">Select a term</option>
<option value="hypotheses">Hypotheses</option>
<option value="type1">Type I error</option>
<option value="type2">Type II error</option>
...
<p><strong>e)</strong> Release the app claiming that the mean error is at most 100 calories, but users complain because the app is actually much less accurate.</p>
<select aria-label="Answer for item e">
<option value="">Select a term</option>
<option value="hypotheses">Hypotheses</option>
<option value="type1">Type I error</option>
<option value="type2">Type II error</option>
...
(function () {
  function initializeMatchingQuiz() {
    ...
    if (!quiz || quiz.dataset.initialized === "true") {
      return;
    }
    ...
    const checkButton = quiz.querySelector(".check-match");
    const resetButton = quiz.querySelector(".reset-match");
    ...
    checkButton.addEventListener("click", function () {
      ...
      overallFeedback.className = "overall-feedback";
